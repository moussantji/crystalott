    ...
    <div class="w-50 mb-3 mx-auto">
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                @foreach ($movie->MovieImage as $movieimage)
                    <form method="post" action="{{ route('admin.picture.destroy',$movieimage) }}">
                        @csrf
                        @method('delete')

                        <div class="carousel-item active" id="movieimage{{ $movieimage->id }}">
                            <img src="{{ $movieimage->getImageUrl(150, 150) }}"
