...
@section('content')
    ...
    <section class="page-header">
        ...
        <!-- /.page-header__bg -->
        <div class="container">
            <h2 class="page-header__title bw-split-in-left">419 Error</h2><!-- /.page-title -->
            <ul class="ienet-breadcrumb list-unstyled">
                <li><a href="{{ route('welcome') }}">Home</a></li>
                <li><span>419 Error</span></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 d-flex align-items-center wow fadeInUp" data-wow-delay="300ms">
                    <div class="error-404__content">
                        ...
                        <h3 class="error-404__sub-title">Page Expired</h3><!-- /.error-404__title -->
