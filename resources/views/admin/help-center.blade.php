          ...
          <div class="page-content">
            ...
            <div class="container-xxl">
                 <div class="row justify-content-center">
                      <div class="col-lg-12">
                           <div class="card overflow-hidden" style="background: url('assets/images/small/img-2.jpg'); ">
                           ...
                           <div class="card">
                                <div class="card-body">
                                     ...
                                     <div class="d-flex align-items-center gap-2">
                                          <img src="assets/images/users/avatar-1.jpg" alt="user photo" class="avatar-sm rounded-circle">
                      ...
                      <div class="col-lg-4">
                           <div class="card">
                                <div class="card-body">
                                     ...
                                     <div class="d-flex align-items-center gap-2">
                                          <img src="assets/images/users/avatar-2.jpg" alt="user photo" class="avatar-sm rounded-circle">
                      ...
                      <div class="col-lg-4">
                           <div class="card">
                                <div class="card-body">
                                     ...
                                     <div class="d-flex align-items-center gap-2">
                                          <img src="assets/images/users/avatar-3.jpg" alt="user photo" class="avatar-sm rounded-circle">
                      ...
                      <div class="col-lg-4">
                           <div class="card">
                                <div class="card-body">
                                     ...
                                     <div class="d-flex align-items-center gap-2">
                                          <img src="assets/images/users/avatar-4.jpg" alt="user photo" class="avatar-sm rounded-circle">
                      ...
                      <div class="col-lg-4">
                           <div class="card">
                                <div class="card-body">
                                     ...
                                     <div class="d-flex align-items-center gap-2">
                                          <img src="assets/images/users/avatar-5.jpg" alt="user photo" class="avatar-sm rounded-circle">
                      ...
                      <div class="col-lg-4">
                           <div class="card">
                                <div class="card-body">
                                     ...
                                     <div class="d-flex align-items-center gap-2">
                                          <img src="assets/images/users/avatar-6.jpg" alt="user photo" class="avatar-sm rounded-circle">
                      ...
                      <div class="col-lg-4">
                           <div class="card">
                                <div class="card-body">
                                     ...
                                     <div class="d-flex align-items-center gap-2">
                                          <img src="assets/images/users/avatar-7.jpg" alt="user photo" class="avatar-sm rounded-circle">
                      ...
                      <div class="col-lg-4">
                           <div class="card">
                                <div class="card-body">
                                     ...
                                     <div class="d-flex align-items-center gap-2">
                                          <img src="assets/images/users/avatar-8.jpg" alt="user photo" class="avatar-sm rounded-circle">
                      ...
                      <div class="col-lg-4">
                           <div class="card">
                                <div class="card-body">
                                     ...
                                     <div class="d-flex align-items-center gap-2">
                                          <img src="assets/images/users/avatar-9.jpg" alt="user photo" class="avatar-sm rounded-circle">
